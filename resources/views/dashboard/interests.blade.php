...
<head>
    ...
    <title>Interests - Moshi K. Maftaha</title>
...
<body>
    ...
    <div class="container">
        <div class="page-header">
            <h1 class="page-title">People <span class="highlight-green">Interested</span></h1>
            <p class="page-subtitle">Recent interest notifications for your designs</p>
        </div>

        <div class="dashboard-section">
            <h3>Latest interests</h3>
            @if($recentInterests->isEmpty())
                <div class="empty-state">
                    <p>No interest notifications yet.</p>
                </div>
            @else
                        ...
                        <div class="project-card">
                            <div class="project-info">
                                <div class="project-title">
                                    {{ $interest->project?->title ?? 'Unknown project' }}
                                </div>
                                ...
                                @if($interest->name || $interest->email)
                                    <div class="project-category">
                                        {{ $interest->name ?? 'Someone' }}
                                        @if($interest->email)
                                            · <a href="mailto:{{ $interest->email }}" style="color:#00ff88;text-decoration:none;">
                                                {{ $interest->email }}
                                              </a>
                                        @endif
                                    </div>
